  ...
  try {
    ...
    if (exists) {
      ...
      if (functionExists.rows[0].exists) {
        ...
        console.log('  Trigger not created. Run initial migration first.');
      }
    ...
    if (error.code === '42P01') {
      console.error('\nNote: The update_updated_at_column() function might not exist.');
      console.error('This is usually created in the initial migration.');
    }
    throw error;
  } finally {
    client.release();
